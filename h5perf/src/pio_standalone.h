...
#define HDstrcat(S,T)    strcat(S,T)
...
#define HDmemset(D,C,N)    memset(D,C,N)
#define HDfree(M)    free(M)
#define HDgetenv(M)    getenv(M)

#define HDmkdir(P,M)    mkdir(P,M)
#define HDstrcasecmp(S,T)    strcasecmp(S,T)
